    ...
    fields: [
      ...
      },
      {
      ...
      },
        {
            ...
            type: "select",
            options: [
            { label: "אפשרות א'", value: "option-a" },
            { label: "אפשרות ב'", value: "option-b" },
            { label: "אפשרות ג'", value: "option-c" }
            ],
    ...
    fields: [
      {
        ...
        type: "select",
        options: [
          { label: "בסיסית", value: "basic" },
          { label: "מתקדמת", value: "pro" },
          { label: "ארגונית", value: "enterprise" }
        ],
        required: true,
      ...
      },
      {
        ...
        type: "radio",
        options: [
          { label: "דוא" + "\"ל", value: "email" },
          { label: "קישור", value: "link" },
          { label: "איסוף עצמי", value: "pickup" }
        ],
